...
<!-- Mirrored from templates.themevessel.com/the-nest/favorited-properties.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:12:12 GMT -->
<head>
    <!-- Google Tag Manager -->
                ...
                <table class="manage-table responsive-table">
                    ...
                    <tr>
                        <td class="title-container">
                            <img src="img/properties/properties-1.jpg" alt="properties" class="img-responsive hidden-xs">
                            <div class="title">
                        ...
                        <td class="expire-date hidden-xs">December 17 2020</td>
                        <td class="action">
                    ...
                    <tr>
                        <td class="title-container">
                            <img src="img/properties/properties-2.jpg" alt="properties" class="img-responsive hidden-xs">
                            <div class="title">
                                <h4><a href="#">Beautiful  family  home </a></h4>
                                <span><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </span>
                                <span class="table-property-price">$900 / monthly</span>
                    ...
                    <tr>
                        <td class="title-container">
                            <img src="img/properties/properties-3.jpg" alt="properties" class="img-responsive hidden-xs">
                            <div class="title">
                                <h4><a href="#">Beautiful  family  home </a></h4>
                                <span><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </span>
                                <span class="table-property-price">$900 / monthly</span>
                    ...
                    <tr>
                        <td class="title-container">
                            <img src="img/properties/properties-4.jpg" alt="properties" class="img-responsive hidden-xs">
                            <div class="title">
                                <h4><a href="#">Beautiful  family  home </a></h4>
                                <span><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </span>
                                <span class="table-property-price">$900 / monthly</span>
                    ...
                    <tr class="b-none">
                        <td class="title-container">
                            <img src="img/properties/properties-5.jpg" alt="properties" class="img-responsive hidden-xs">
                            <div class="title">
                                <h4><a href="#">Beautiful  family  home </a></h4>
                                <span><i class="fa fa-map-marker"></i> 123 Kathal St. Tampa City, </span>
                                <span class="table-property-price">$900 / monthly</span>
