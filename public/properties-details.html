...
<!-- Mirrored from templates.themevessel.com/the-nest/properties-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:13 GMT -->
<head>
    <!-- Google Tag Manager -->
                    ...
                    <div class="properties-detail-slider simple-slider mb-40">
                        <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators thumbs visible-lg visible-md">
                                <li data-target="#carousel-custom" data-slide-to="0" class=""><img src="img/properties/properties-1.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="1" class=""><img src="img/properties/properties-3.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="2" class=""><img src="img/properties/properties-4.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="3" class=""><img src="img/properties/properties-5.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="4" class=""><img src="img/properties/properties-2.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="5" class=""><img src="img/properties/properties-6.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="6" class=""><img src="img/properties/properties-1.jpg" alt="Chevrolet Impala"></li>
                                <li data-target="#carousel-custom" data-slide-to="7" class=""><img src="img/properties/properties-2.jpg" alt="Chevrolet Impala"></li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                ...
                <div class="sidebar right">
                    ...
                    <div class="sidebar-widget contact-1 mortgage-calculator">
                        ...
                        <div class="contact-form">
                            <form id="agent_form" action="https://templates.themevessel.com/the-nest/index.html" method="GET" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
...
<!-- Mirrored from templates.themevessel.com/the-nest/properties-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:16 GMT -->
</html>
