...
<!-- Mirrored from templates.themevessel.com/the-nest/pricing-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:35 GMT -->
<head>
    <!-- Google Tag Manager -->
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="pricing-2">
                    ...
                    <div class="price-for-user">
                        <div class="price"><sup>$</sup><span class="dolar active-c">35</span><small class="month">per month</small></div>
                    </div>
                    <div class="content">
                        <ul>
                            <li>20 Projects</li>
