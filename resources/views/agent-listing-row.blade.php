...
<!-- Mirrored from templates.themevessel.com/the-nest/agent-listing-row.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:22 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="agent-2 clearfix">
                    <div class="col-lg-5 col-md-5 col-sm-12 agent-theme-2">
                        <img src="img/team/team-4.jpg" alt="team-3" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
