...
<!-- Mirrored from templates.themevessel.com/the-nest/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:10:45 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item item-100vh active">
                <img src="img/banner/img-1.jpg" alt="banner-slider-1">
                <div class="carousel-caption banner-slider-inner">
                    <div class="banner-content bc-2 container banner-content-left">
                        <h1 data-animation="animated fadeInDown delay-05s">Find your Dream House</h1>
            ...
            <div class="item item-100vh">
                <img src="img/banner/img-4.jpg" alt="banner-slider-2">
                <div class="carousel-caption banner-slider-inner">
                    <div class="banner-content bc-2 container banner-content-left">
                        <h1 data-animation="animated fadeInDown delay-1s">Sweet Home For Small Family</h1>
                        <p data-animation="animated fadeInUp delay-1s">Allow us to guide you through the innovative stress free approach<br class="n-786"> in finding your dream Properties.</p>
                        <a href="#" class="btn button-md button-theme" data-animation="animated fadeInUp delay-15s">Get Started Now</a>
                        <a href="#" class="btn button-md border-button-theme" data-animation="animated fadeInUp delay-15s">Learn More</a>
                    </div>
            ...
            <div class="item item-100vh">
                <img src="img/banner/img-3.jpg" alt="banner-slider-3">
                <div class="carousel-caption banner-slider-inner">
                    <div class="banner-content bc-2 container banner-content-left">
                        <h1 data-animation="animated fadeInDown delay-1s">Best Place To Find Home</h1>
                        <p data-animation="animated fadeInUp delay-1s">Allow us to guide you through the innovative stress free approach<br class="n-786"> in finding your dream Properties.</p>
                        <a href="#" class="btn button-md button-theme" data-animation="animated fadeInUp delay-15s">Get Started Now</a>
                        <a href="#" class="btn button-md border-button-theme" data-animation="animated fadeInUp delay-15s">Learn More</a>
                    </div>
            ...
            <div class="item item-100vh">
                <img src="img/banner/img-2.jpg" alt="banner-slider-2">
                <div class="carousel-caption banner-slider-inner">
                    <div class="banner-content bc-2 container banner-content-left">
                        <h1 data-animation="animated fadeInDown delay-1s">Sweet Home For Small Family</h1>
                        <p data-animation="animated fadeInUp delay-1s">Allow us to guide you through the innovative stress free approach<br class="n-786"> in finding your dream Properties.</p>
        ...
        <div class="row wow fadeInUp delay-04s">
            <div class="filtr-container">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="1, 2, 3">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-13.jpg" alt="photo" class="img-responsive">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="1">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-14.jpg" alt="photo" class="img-responsive">
                        </div>
                        <div class="featured-tag2">Featured</div>
                        <div class="sale-tag">For Sale</div>
                        <div class="ling-section">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="2, 3">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-15.jpg" alt="photo" class="img-responsive">
                        </div>
                        <div class="featured-tag2">Featured</div>
                        <div class="sale-tag">For Sale</div>
                        <div class="ling-section">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="4">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-16.jpg" alt="photo" class="img-responsive">
                        </div>
                        <div class="featured-tag2">Featured</div>
                        <div class="sale-tag">For Sale</div>
                        <div class="ling-section">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="3, 4">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-17.jpg" alt="photo" class="img-responsive">
                        </div>
                        <div class="featured-tag2">Featured</div>
                        <div class="sale-tag">For Sale</div>
                        <div class="ling-section">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12  filtr-item" data-category="1">
                    <div class="property-3">
                        <div class="blog-photo">
                            <img src="img/properties/properties-18.jpg" alt="photo" class="img-responsive">
                        </div>
                        <div class="featured-tag2">Featured</div>
                        <div class="sale-tag">For Sale</div>
                        <div class="ling-section">
    ...
    <div class="container">
        ...
        <div class="row mgn-btm wow">
            ...
            <div class="col-lg-12 col-sm-12 text-center wow fadeInUp delay-04s">
                <a href="services-1.html" class="btn btn-outline-2">Read More</a>
            </div>
        </div>
    </div>
</div>
...
<div class="categories content-area-12">
    <div class="container">
        ...
        <div class="clearfix"></div>
        <div class="row wow">
            <div class="col-lg-5 col-md-5 col-sm-7 col-pad wow fadeInLeft delay-04s">
                <div class="category">
            ...
            <div class="col-lg-3 col-md-3 col-sm-5 wow fadeInUp delay-04s">
                <div class="row">
                    <div class="col-sm-12 col-pad">
                        <div class="category">
                            <div class="category_bg_box cat-3-bg category_long_bg2">
                                <div class="category-overlay">
                                    <div class="cc2">
                                        <h6>14 Properties</h6>
                                        <h4>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 wow fadeInRight delay-04s">
                <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="testimonials-box">
                                        ...
                                        <div class="detail clearfix">
                                            <P><i class="fa fa-quote-left"></i> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took. <i class="fa fa-quote-right"></i></P>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="media-heading">
                                                        <a href="properties-details.html">Anne Brady</a>
                                                    </h5>
                                    ...
                                    <div class="testimonials-box">
                                        ...
                                        <div class="detail clearfix">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="media-heading">
                                                        <a href="properties-details.html">Michelle Nelson</a>
                                                    </h5>
                                                    <p>Creative Director, india</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="testimonials-box">
                                        ...
                                        <div class="detail clearfix">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="media-heading">
                                                        <a href="properties-details.html">Auro Navanth</a>
                                                    </h5>
                                                    <p>Web Designer, Uk</p>
                                                </div>
                                            </div>
                    ...
                    <form action="#" method="GET" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
                                <div class="send-btn">
                                    <button type="submit" class="btn button-theme btn-md btn-block">Get it now</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<!-- Mirrored from templates.themevessel.com/the-nest/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:10:57 GMT -->
</html>
