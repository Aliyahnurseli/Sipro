...
<!-- Mirrored from templates.themevessel.com/the-nest/contact-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:12:04 GMT -->
<head>
    <!-- Google Tag Manager -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group send-btn mb-0 text-center">
                                    <button type="submit" class="button-md button-theme mb-50">Send Message</button>
                                </div>
                            </div>
                        </div>
                    </form>
