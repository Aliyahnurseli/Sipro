...
<!-- Mirrored from templates.themevessel.com/the-nest/agent-listing-row-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:22 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class="agent-2 a-2 clearfix">
                    <div class="col-lg-4 col-md-4 col-sm-4 agent-theme-2">
                        <img src="img/team/team-3.jpg" alt="team-2" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
                ...
                <div class="agent-2 a-2 clearfix">
                    <div class="col-lg-4 col-md-4 col-sm-4 agent-theme-2">
                        <img src="img/team/team-4.jpg" alt="team-2" class="img-responsive">
                        <!-- social list -->
                        <ul class="social-list clearfix">
                            <li>
                                <a href="#" class="facebook">
...
<!-- Mirrored from templates.themevessel.com/the-nest/agent-listing-row-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:26 GMT -->
</html>
