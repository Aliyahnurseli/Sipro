    ...
    <div class="row mt-4 mb-4 pt-4 pb-4">
        ...
        <div class="col-sm-4">
            <div class="judul font-weight-bold" style="display: flex">
                <i class="fas fa-phone-alt fa-2x mr-2" style="color: red; display: inline-block;"></i><h2>Property</h2>
            </div>
            ...
            <nav class="nav flex-column">
                <a class="nav-link text-muted mb-2" data-toggle="collapse" href="#satu" role="button" aria-expanded="false" aria-controls="satu">
                    <i class="fa fa-angle-right mr-2"></i>Property Dijual
                </a>
                ...
                <a class="nav-link text-muted mb-2" data-toggle="collapse" href="#dua" role="button" aria-expanded="false" aria-controls="dua">
                    <i class="fa fa-angle-right mr-2"></i>Property Disewa
                </a>
                <div class="bg-secondary" style="height: 1px; opacity: 0.2;"></div>
            </nav>
        </div>
        <div class="col-sm-8">
            <div class="collapsed" id="satu" >
              ...
              <!--  <img alt="PMI-Im" src="img/Logo-PMI-im.png" height="200px" width="750px" />-->
                <p class="text-danger font-weight-bold">Syarat Sah Surat Perjanjian Sewa Rumah</p>
                <p>1. Adanya kesepakatan antar pihak yang terlibat perjanjian</p>
                <p>2. Pihak yang bersepakat harus cakap</p>
                <p>3. Adanya suatu tujuan tertentu</p>
                <p>4. Adanya suatu sebab yang halal</p>
                <p class="text-danger font-weight-bold">Syarat Sah Surat Perjanjian Jual Rumah</p>
                <p>1. Kartu Tanda Penduduk (KTP)</p>
