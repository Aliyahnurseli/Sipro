                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-white m-b-0">All Developer</h6>
                                                            </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-white m-b-0">All Property</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-white m-b-0">All Pelanggan</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-end">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-white m-b-0">Traffic Web</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                            ...
                                            <div class="col-xl-9 col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <span class="text-muted">Grafik penawaran property .</span>
                                            ...
                                            <div class="col-xl-3 col-md-12">
                                                <div class="card user-card2">
                                                    <div class="card-block text-center">
                                                        <h6 class="m-b-15">Pengaduan Pelanggan</h6>
                                                        <div class="risk-rate">
                                                            <span><b>5</b></span>
                                                        </div>
                                                        <h6 class="m-b-10 m-t-10">Jumlah</h6>
                                                        <a href="#!" class="text-c-yellow b-b-warning">Pengaduan
                                                            </a>
                                                        <div
                                                            class="row justify-content-center m-t-10 b-t-default m-l-0 m-r-0">
                                                            <div class="col m-t-15 b-r-default">
                                                                <h6 class="text-muted">Belum DiJawab</h6>
                                                                <h6>2455</h6>
                                                            </div>
                                                            <div class="col m-t-15">
                                                                <h6 class="text-muted">Sudah Terjawab</h6>
                                                                <h6>30</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button class="btn btn-warning btn-block p-t-15 p-b-15">Lihat Semua Aduan</button>
                                                </div>
                                            </div>
                                            <!--  sale analytics end -->
                                            ...
                                            <div class="col-xl-6 col-md-12">
                                                <div class="card user-card-full">
                                                    <div class="row m-l-0 m-r-0">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="card-block">
                                                                <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Bantuan Sistem
                                                                </h6>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Email</p>
                                                                        <h6 class="text-muted f-w-400">sya4li@gmail.com
                                                                        </h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Phone</p>
                                                                        <h6 class="text-muted f-w-400">081931745058
                                                                        </h6>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">Jl. Tata Bumi Selatan No.109, Kel.Banyuraden, Kec.Gamping, Kab, Sleman, DIY
                                                                        </h6>
                                                                    </div>
