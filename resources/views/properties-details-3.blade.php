...
<!-- Mirrored from templates.themevessel.com/the-nest/properties-details-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:16 GMT -->
<head>
    <!-- Google Tag Manager -->
                ...
                <div class="properties-detail-slider simple-slider mb-40">
                    <div id="carousel-custom" class="carousel slide" data-ride="carousel">
                        <div class="carousel-outer">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="img/properties/properties-10.jpg" class="thumb-preview" alt="Chevrolet Impala">
                                </div>
                                <div class="item">
                                    <img src="img/properties/properties-11.jpg" class="thumb-preview" alt="Chevrolet Impala">
                                </div>
                                <div class="item">
                                    <img src="img/properties/properties-12.jpg" class="thumb-preview" alt="Chevrolet Impala">
                                </div>
                                <div class="item">
                                    <img src="img/properties/properties-10.jpg" class="thumb-preview" alt="Chevrolet Impala">
                                </div>
                        ...
                        <ol class="carousel-indicators thumbs visible-lg visible-md">
                            <li data-target="#carousel-custom" data-slide-to="0" class=""><img src="img/properties/properties-10.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="1" class=""><img src="img/properties/properties-11.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="2" class=""><img src="img/properties/properties-12.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="3" class=""><img src="img/properties/properties-10.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="4" class=""><img src="img/properties/properties-11.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="5" class=""><img src="img/properties/properties-12.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="6" class=""><img src="img/properties/properties-10.jpg" alt="Chevrolet Impala"></li>
                            <li data-target="#carousel-custom" data-slide-to="7" class=""><img src="img/properties/properties-11.jpg" alt="Chevrolet Impala"></li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="tab1default">
                                        ...
                                        <p>Nam mattis lobortis felis eu blandit. Morbi tellus ligula, interdum sit amet ipsum et, viverra hendrerit lectus. Nunc efficitur sem vel est laoreet, sed bibendum eros viverra. Vestibulum finibus, ligula sed euismod tincidunt, lacus libero lobortis ligula, sit amet molestie ipsum purus ut tortor. Nunc varius, dui et sollicitudin facilisis, erat felis imperdiet felis</p>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="tab4default">
                                        ...
                                        <div class="floor-plans">
                                            ...
                                            <img src="img/properties/floor-plans.png" alt="floor-plans" class="img-responsive">
                                        </div>
                                        <!-- Floor Plans end -->
                                    </div>
                                ...
                                <li>
                                    <div class="comment">
                                        <div class="comment-author">
                                            <a href="#">
                                                <img src="img/avatar/avatar-5.jpg" alt="avatar-5">
                                            </a>
                                        </div>
                                        <div class="comment-content">
                                            <div class="comment-meta">
                                                ...
                                                <div class="comment-meta-date">
                                                    <span class="hidden-xs">8:42 PM 3/3/2020</span>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
...
<!-- Mirrored from templates.themevessel.com/the-nest/properties-details-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:21 GMT -->
</html>
