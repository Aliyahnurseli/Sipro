...
<!-- Mirrored from templates.themevessel.com/the-nest/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:10:57 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item item-100vh active">
                <img src="img/banner/img-4.jpg" alt="banner-slider-1">
                <div class="carousel-caption banner-slider-inner">
                    <div class="banner-content container banner-content-left">
                        <div class="banner-content banner-content-left wow fadeInDown delay-04s">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="banner-detail-box bdb-2 text-left wow fadeInDown delay-04s">
                                        <h2 data-animation="animated fadeInDown delay-05s">Modern <span>Apartment</span> In A New Residential Complex</h2>
                                        <p data-animation="animated fadeInUp delay-1s">Allow us to guide you through the innovative stress free approach<br class="n-786"> in finding your dream Properties.</p>
                ...
                <div class="property">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-pad">
                        ...
                        <div class="property-img">
                            ...
                            <img src="img/properties/properties-14.jpg" alt="fp-list" class="img-responsive hp-2">
                            <div class="property-overlay">
                                ...
                                <div class="property-magnify-gallery">
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-14.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-13.jpg" class="hidden"></a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-15.jpg" class="hidden"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="property">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-pad">
                        ...
                        <div class="property-img">
                            <div class="property-tag button alt featured">Featured</div>
                            <div class="property-price">$150,000</div>
                            <img src="img/properties/properties-15.jpg" alt="fp-list" class="img-responsive hp-2">
                            <div class="property-overlay">
                                <a href="properties-details.html" class="overlay-link">
                                    <i class="fa fa-link"></i>
                                </a>
                                ...
                                <div class="property-magnify-gallery">
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-15.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-13.jpg" class="hidden"></a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-14.jpg" class="hidden"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="property">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-pad">
                        ...
                        <div class="property-img">
                            <div class="property-tag button alt featured">Featured</div>
                            <div class="property-price">$150,000</div>
                            <img src="img/properties/properties-13.jpg" alt="fp-list" class="img-responsive hp-2">
                            <div class="property-overlay">
                                <a href="properties-details.html" class="overlay-link">
                                    <i class="fa fa-link"></i>
                                </a>
                                ...
                                <div class="property-magnify-gallery">
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-13.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-14.jpg" class="hidden"></a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-15.jpg" class="hidden"></a>
                ...
                <div class="property">
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-pad">
                        ...
                        <div class="property-img">
                            <div class="property-tag button alt featured">Featured</div>
                            <div class="property-price">$150,000</div>
                            <img src="img/properties/properties-16.jpg" alt="fp-list" class="img-responsive hp-2">
                            <div class="property-overlay">
                                <a href="properties-details.html" class="overlay-link">
                                    <i class="fa fa-link"></i>
                                </a>
                                ...
                                <div class="property-magnify-gallery">
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-16.jpg" class="overlay-link">
                                        <i class="fa fa-expand"></i>
                                    </a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-14.jpg" class="hidden"></a>
                                    <a href="../../storage.googleapis.com/theme-vessel/template-images/nest-html/assets/img/properties/properties-15.jpg" class="hidden"></a>
...
<div class="our-service-there overview-bgi mb-100">
...
<div class="categories content-area-12">
    <div class="container">
        ...
        <div class="clearfix"></div>
        <div class="row wow">
            <div class="col-lg-8 col-md-8 col-sm-6 col-pad wow fadeInRight delay-04s">
                <div class="category">
                    <div class="category_bg_box category_long_bg cat-7-bg">
                        <div class="category-overlay">
                            <div class="category-content">
                                <div class="category-subtitle">14 Properties</div>
                                <h3 class="category-title"><a href="#">New York City</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="row">
                    <div class="col-sm-12 col-pad wow fadeInLeft delay-04s">
                        <div class="category">
...
<!-- Agent section 1 start -->
<div class="agent-section-1 overview-bgi">
    <div class="container">
        <div class="row">
                            ...
                            <div class="item content clearfix">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="agent-3">
                                        <div class="photo">
                                            <a href="properties-details.html">
                                                <img src="img/avatar/avatar-3.jpg" alt="avatar">
                                            </a>
                                        </div>
                                        <div class="agent-details">
                                            <h5><a href="agent-single.html">Maikel John</a></h5>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="agent-3">
                                        <div class="photo">
                                            <a href="properties-details.html">
                                                <img src="img/avatar/avatar-4.jpg" alt="avatar">
                                            </a>
                                        </div>
                                        <div class="agent-details">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInLeft delay-04s">
                <div class="blog-box-4">
                    <div class="blog-photo">
                        <img src="img/blog/blog-4.jpg" alt="blog" class="img-responsive">
                    </div>
                    <div class="post-meta">
                        <span class="left"><a href="#"><i class="fa fa-user"></i> John Smith</a></span>
                        <span class="right"><a href="#"><i class="fa fa-comments"></i> 7 Days Aso</a></span>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 hidden-sm wow fadeInUp delay-04s">
                <div class="blog-box-4">
                    <div class="blog-photo">
                        <img src="img/blog/blog-5.jpg" alt="blog" class="img-responsive">
                    </div>
                    <div class="post-meta">
                        <span class="left"><a href="#"><i class="fa fa-user"></i> Antony John</a></span>
                        <span class="right"><a href="#"><i class="fa fa-comments"></i> 3 Days Aso</a></span>
                    </div>
                    <div class="ling-section">
                        <h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 wow fadeInRight delay-04s">
                <div class="blog-box-4">
                    <div class="blog-photo">
                        <img src="img/blog/blog-6.jpg" alt="blog" class="img-responsive">
                    </div>
                    <div class="post-meta">
                        <span class="left"><a href="#"><i class="fa fa-user"></i> Konne Backfield</a></span>
                        <span class="right"><a href="#"><i class="fa fa-comments"></i> 10 Days Aso</a></span>
                    </div>
                    <div class="ling-section">
                        <h3>
...
<!-- Mirrored from templates.themevessel.com/the-nest/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Apr 2021 07:11:03 GMT -->
</html>
